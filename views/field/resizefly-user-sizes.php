    ...
    <div class="rzf-user-sizes">
        ...
        <div class="rzf-user-sizes-single">
            <label>
                ...
                <input type="checkbox" name="resizefly_user_sizes[clone][crop]">
            </label>
        </div>
        <div class="rzf-user-sizes-single">
            <label>
        ...
        <div class="rzf-user-sizes-single">
            <button class="button-secondary" id="js-rzf-add-user-size"><?= __( 'Add image size', 'resizefly' ); ?></button>
        </div>
    </div>
...
<?php if ( ! empty( $args['user_sizes'] ) ) : ?>
    ...
    <table class="rzf-image-sizes widefat">
		...
		<?php foreach ( $args['user_sizes'] as $size ) : ?>
            <tr>
                <td>
                    <button class="js-rzf-delete-user-size button-secondary"><?= __( 'Delete Image Size', 'resizefly' ); ?></button>
                </td>
                <td>
					<?= $size['width']; ?>
                ...
                <td>
                    ...
                    <input type="hidden" name="resizefly_user_sizes[<?= $size['name']; ?>][crop]" value="<?= $size['crop']; ?>">
                </td>
                <td>
					<?= $size['name']; ?>
